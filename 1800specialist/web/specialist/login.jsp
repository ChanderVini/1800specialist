...
<title><bean:message key="label.specialist"/>&nbsp;<bean:message key="label.login"/></title>
            ...
            <div class="tabberlive">
                <ul class="tabbernav">    
                    <li id="login" class="tabberactive">
                       <html:link action="spec.spl"><bean:message key="label.login"/></html:link>
                    </li>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="900" class="inputtable">
                ...
                <tr>
                    <td valign="top" colspan="2">
                        <html:form action="/spclogin" method="POST">
                            <table id="dataTable" width="50%" border="0" class="inputsubtable" cellpadding="2" cellspacing="1">
